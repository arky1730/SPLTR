...
- Real audio waveforms with click-and-drag seeking
- Editor-style waveform trimming with draggable IN/OUT handles, movable selection, precise seconds, and clip preview
- 854×480 black-screen vocal MP4 export
